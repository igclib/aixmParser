...
def syntaxe():
    ...
    print("           " + __AppName__ + " ../tst/aixm4.5_SIA-FR_2020-04-23.xml " + aixmReader.CONST.frmtALL + " " + aixmReader.CONST.typeAIRSPACES + " " + aixmReader.CONST.optFreeFlight + " " + aixmReader.CONST.optCleanLog)
    print("")
    print("  Resources")
